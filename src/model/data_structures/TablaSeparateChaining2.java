 ...
 *
 */
public class TablaSeparateChaining2 {
	 ...
	 * 
	 */
	public TablaSeparateChaining2() {
		this(997);
	}

	public TablaSeparateChaining2 (int M)
	{
		this.M = M;
	...
	private void resize(int chains) {
		...
		TablaSeparateChaining2 temp = new TablaSeparateChaining2(chains);
		for (int i = 0; i < M; i++) {
//			for (K key : st[i].keys()) {
